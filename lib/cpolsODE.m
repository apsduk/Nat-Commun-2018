function dY = cpolsODE(T, Y, model, hPR, cPR, cXlist)

%% cpolsODE
%
% Function which builds ODEs for simulate a synthetic circuit. This model
% allows the use of both the host ribosomes (pR) and orthogonal ribosomes
% (pP)
%
%   dY = cpolsODE(T, Y, model, hPR, cPR, cXlist)
%
...
%% simulate circuit dC
[dC,eEusage,pRusage] = circODE(T, C, gamma, lambda, hPR, cPR, eE, [pR; pP]);

%% update host based on circuit
% update energy status
deE = deE + eEusage;

% update h-ribosome usage
dpR = dpR + pRusage(1); 

% update o-ribosome usage
dpP = dpP + pRusage(2);
...
%% return dY
dY = [diS; deE; dmT; dcT; dzT; dpT; dmE; dcE; dzE; dpE; dmH; dcH; dzH; dpH; dmR; dcR; dzR; dxR; drR; dpR; drP; dpP; dC; dN];
