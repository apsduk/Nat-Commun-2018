function [dC, eEusage, ribousage] = twogenes_cpols_hA_hB(T, C, gamma, lambda, hpar, cpar, eE, ribo)

%% twogenes_cpols_hA_hB
%
% Two gene circuit where both pA and pB are translated by the h-ribo pool. Use this to test the impact of expressing o-ribo on a host utilising circuit.
%
%   [dC, eEusage, ribousage] = twogenes_cpols_hA_hB(T, C, gamma, lambda, hpar, cpar, eE, ribo)
%
...
%% update ribosomes
pRusage = m2pA - bA*pR*mA + uA*cA + m2pB - bB*pR*mB + uB*cB;
pPusage = 0;
