function [dC, eEusage, pRusage] = twogenes(T, C, gamma, lambda, hpar, cpar, eE, pR)

%% twogenes
%
% Two gene circuits with no regulation between the genes.
%
%   [dC, eEusage, pRusage] = twogenes(T, C, gamma, lambda, hpar, cpar, eE, pR)
%
