function [dC, eEusage, ribousage] = twogenes_cpols_oA_hB(T, C, gamma, lambda, hpar, cpar, eE, ribo)

%% twogenes_cpols_oA_hB
%
% Two gene circuit where pA is translated by the o-ribo and pB is
% translated by the h-ribo.
%
%   [dC, eEusage, ribousage] = twogenes_cpols_oA_hB(T, C, gamma, lambda, hpar, cpar, eE, ribo)
%
...
%% circuit ODEs
% protein A
dmA = g2mA - (lambda+dymA)*mA + m2pA - bA*pP*mA + uA*cA;
dcA = -(lambda+dypR)*cA + bA*pP*mA - uA*cA - m2pA - fcm*cm0*cA + rcm*zA;
...
%% update ribosomes
pPusage = m2pA - bA*pP*mA + uA*cA;
pRusage = m2pB - bB*pR*mB + uB*cB;
